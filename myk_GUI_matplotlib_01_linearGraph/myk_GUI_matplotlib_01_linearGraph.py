...
class BottomPanel(wx.Panel):
    def __init__(self, parent, top):
        ...
        self.buttonPlot01.Bind(wx.EVT_BUTTON, self.SetButtonPlot01)

    #　GUIフォームに紐づけた関数指定
    def SetButtonPlot01(self, event):
        ...
        print("[DEBUG]SetButtonPlot01: %s is clicked" % (cb.GetLabel()))
